...
Sweden = os.path.join(Home,"Sweden")
RealReturns = os.path.join(Home,"Sweden/Real_Returns")
SimReturns = os.path.join(Home,"Sweden/Sim_Returns")

#load the files to work with
fins = os.listdir(RealReturns)
#place to store our sims
os.chdir(Sweden)
store = pd.HDFStore("SwedishSimStorage.h5")
filelist = []
for fin in fins:
